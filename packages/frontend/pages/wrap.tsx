...
import Wrapepd from '../components/NFTTabs/Wrapped';
import Available from '../components/NFTTabs/Available';

const WrapPage = (): JSX.Element => {
  ...
  const tabs = [
    { name: 'Available to Wrap', component: <Available contract={myNFTContract} /> },
  ];
